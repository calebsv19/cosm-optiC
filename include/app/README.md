...
- `ray_tracing_runtime_host.h` – Runtime host init/shutdown contract for SDL/window/renderer and render-context ownership, including read-only lifecycle snapshot, clean-state validation, and last-failure diagnostics.

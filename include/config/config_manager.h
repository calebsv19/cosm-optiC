...
#define RUNTIME_3D_TRANSMISSION_SAMPLES_MIN 1
...
#define RUNTIME_3D_RENDER_SCALE_DEFAULT RUNTIME_3D_RENDER_SCALE_HIDPI
...
typedef enum {
    RAY_TRACING_MESH_IMPORT_NORMAL_MODE_NONE = 0,
    RAY_TRACING_MESH_IMPORT_NORMAL_MODE_SMOOTH = 1,
    RAY_TRACING_MESH_IMPORT_NORMAL_MODE_CREASE_AWARE = 2
} RayTracingMeshImportNormalMode;

#define RAY_TRACING_MESH_IMPORT_NORMAL_MODE_DEFAULT \
    RAY_TRACING_MESH_IMPORT_NORMAL_MODE_CREASE_AWARE
#define RAY_TRACING_MESH_IMPORT_CREASE_ANGLE_MIN 1.0
#define RAY_TRACING_MESH_IMPORT_CREASE_ANGLE_MAX 180.0
#define RAY_TRACING_MESH_IMPORT_CREASE_ANGLE_DEFAULT 60.0
...
typedef struct {
    ...
    int meshImportNormalMode;
    double meshImportCreaseAngleDegrees;
    char outputRoot[256];
    char frameDir[256];

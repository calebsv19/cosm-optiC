...
CFLAGS += $(TIMER_HUD_INCLUDE) -I$(VK_RENDERER_DIR)/include -I$(VK_RUNTIME_DIR)/include $(VULKAN_CFLAGS) \
	-I$(CORE_BASE_DIR)/include -I$(CORE_IO_DIR)/include -I$(CORE_DATA_DIR)/include -I$(CORE_PACK_DIR)/include -I$(CORE_QUEUE_DIR)/include -I$(CORE_TIME_DIR)/include -I$(CORE_WORKERS_DIR)/include -I$(CORE_SIM_DIR)/include -I$(CORE_SCENE_DIR)/include -I$(CORE_SCENE_VIEW_DIR)/include -I$(CORE_VIEWPORT3D_DIR)/include -I$(CORE_SCREEN_PICK_DIR)/include -I$(CORE_AUTHORED_TEXTURE_DIR)/include -I$(CORE_SCENE_COMPILE_DIR)/include -I$(CORE_MESH_ASSET_DIR)/include -I$(CORE_MESH_PREVIEW_DIR)/include -I$(CORE_MESH_PREVIEW_DIR)/../../shape/external -I$(CORE_OBJECT_DIR)/include -I$(CORE_UNITS_DIR)/include -I$(CORE_TRACE_DIR)/include -I$(CORE_SPACE_DIR)/include -I$(CORE_PANE_DIR)/include -I$(CORE_PANE_MODULE_DIR)/include -I$(CORE_THEME_DIR)/include -I$(CORE_FONT_DIR)/include -I$(KIT_RENDER_DIR)/include -I$(KIT_UI_DIR)/include -I$(KIT_PANE_DIR)/include -I$(KIT_VIZ_DIR)/include -I$(KIT_RUNTIME_DIAG_DIR)/include -I$(KIT_VIEWPORT3D_DIR)/include -I$(KIT_WORKSPACE_AUTHORING_DIR)/include \
...
LDFLAGS += $(VULKAN_LIBS)
CFLAGS_RELEASE += $(TIMER_HUD_INCLUDE) -I$(VK_RENDERER_DIR)/include -I$(VK_RUNTIME_DIR)/include $(VULKAN_CFLAGS) \
	-I$(CORE_BASE_DIR)/include -I$(CORE_IO_DIR)/include -I$(CORE_DATA_DIR)/include -I$(CORE_PACK_DIR)/include -I$(CORE_QUEUE_DIR)/include -I$(CORE_TIME_DIR)/include -I$(CORE_WORKERS_DIR)/include -I$(CORE_SIM_DIR)/include -I$(CORE_SCENE_DIR)/include -I$(CORE_SCENE_VIEW_DIR)/include -I$(CORE_VIEWPORT3D_DIR)/include -I$(CORE_SCREEN_PICK_DIR)/include -I$(CORE_AUTHORED_TEXTURE_DIR)/include -I$(CORE_SCENE_COMPILE_DIR)/include -I$(CORE_MESH_ASSET_DIR)/include -I$(CORE_MESH_PREVIEW_DIR)/include -I$(CORE_MESH_PREVIEW_DIR)/../../shape/external -I$(CORE_OBJECT_DIR)/include -I$(CORE_UNITS_DIR)/include -I$(CORE_TRACE_DIR)/include -I$(CORE_SPACE_DIR)/include -I$(CORE_PANE_DIR)/include -I$(CORE_PANE_MODULE_DIR)/include -I$(CORE_THEME_DIR)/include -I$(CORE_FONT_DIR)/include -I$(KIT_RENDER_DIR)/include -I$(KIT_UI_DIR)/include -I$(KIT_PANE_DIR)/include -I$(KIT_VIZ_DIR)/include -I$(KIT_RUNTIME_DIAG_DIR)/include -I$(KIT_VIEWPORT3D_DIR)/include -I$(KIT_WORKSPACE_AUTHORING_DIR)/include \
	-I$(CORE_HEADLESS_JOB_DIR)/include \
	-DKIT_RENDER_ENABLE_VK_BACKEND=0 \
	-DUSE_VULKAN=1 -DVK_RUNTIME_BUILD_VERSION=\"$(VK_RUNTIME_VERSION)\" \

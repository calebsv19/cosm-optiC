...
ray-tracing-job-runner: $(RAY_TRACING_JOB_RUNNER_BIN) $(RAY_TRACING_WORKER_RUNTIME_BIN)
...
ray-tracing-worker-runtime: $(RAY_TRACING_WORKER_RUNTIME_BIN)
	@echo "ray_tracing process-neutral worker runtime ready: $(RAY_TRACING_WORKER_RUNTIME_BIN)"

$(RAY_TRACING_WORKER_RUNTIME_BIN): $(RAY_TRACING_WORKER_RUNTIME_OBJ) $(RAY_TRACING_WORKER_RUNTIME_DEPS)
	@mkdir -p $(dir $@)
	$(CC) $(RAY_TRACING_WORKER_RUNTIME_OBJ) $(RAY_TRACING_WORKER_RUNTIME_DEPS) -o $@ $(JSON_LIBS)

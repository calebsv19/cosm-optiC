...
package-linux-desktop-self-test: package-linux-desktop
	...
	@test -f "$(LINUX_DESKTOP_CONFIG_DIR)/samples/light_timeline_editor_demo_runtime.json" || (echo "Missing light timeline editor demo scene"; exit 1)
	@test -f "$(LINUX_DESKTOP_CONFIG_DIR)/samples/light_timeline_editor_demo_request.json" || (echo "Missing light timeline editor demo request"; exit 1)

...
RAY_TRACING_WORKER_RUNTIME_SRC := $(SRC_DIR)/tools/cli/ray_tracing_worker_runtime.c
RAY_TRACING_WORKER_RUNTIME_BIN := $(BUILD_DIR)/tools/cli/ray_tracing_worker_runtime
RAY_TRACING_WORKER_RUNTIME_OBJ := $(BUILD_DIR)/tools/cli/ray_tracing_worker_runtime.o
RAY_TRACING_SCENE_PROJECT_REQUEST_TOOL_SRC := $(SRC_DIR)/tools/cli/scene_project_render_request_tool.c
RAY_TRACING_SCENE_PROJECT_REQUEST_TOOL_BIN := $(BUILD_DIR)/tools/cli/scene_project_render_request_tool
RAY_TRACING_SCENE_PROJECT_REQUEST_TOOL_OBJ := $(BUILD_DIR)/tools/cli/scene_project_render_request_tool.o

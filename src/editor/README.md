...
- `camera_editor.c` – Fully interactive camera tooling: click-drag to pan, scroll/± to zoom, adjust the saved margin, and preview the scene through the active camera.

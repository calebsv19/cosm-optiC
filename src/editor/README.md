...
- `scene_editor_transform_panel.c` – Object-mode right-pane inspector for numeric XYZ position/degree rotation/per-axis scale, rename/duplicate/remove, undo/redo, explicit-unit managed STL intake, and per-instance shading/crease controls.

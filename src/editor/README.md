...
- `editor_mode_router.c` – Canonical editor mode routing layer that centralizes mode clamp/cycle policy, backend-routed view-context construction, and explicit `3D scaffold -> 2D backend` capability labeling until full 3D edit math lands.

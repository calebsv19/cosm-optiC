...
#define VALUE_BOX_MARGIN_X 20
#define VALUE_BOX_MARGIN_Y 10
...
int rouletteSliderValue = 10; // stores threshold * 1000
int envSliderValue = 0;
int cacheWeightSliderValue = 100;
int lightIntensitySliderValue = 500;
int lightDecaySoftnessSliderValue = 100; // maps to 0.1..10.0
int forwardDecaySliderValue = 2000;
int oldWindowWidth = 0;
int oldWindowHeight = 0;
Uint32 statusExpireMs = 0;
...
ManifestOption g_manifestOptions[MAX_MANIFEST_OPTIONS];
size_t g_manifestOptionCount = 0;
bool g_manifestDropdownOpen = false;
bool g_manifestLoadEnabled = false;
SDL_Rect g_manifestPanelRect = {0};
SDL_Rect g_manifestListRect = {0};
SDL_Rect g_manifestScrollbarRect = {0};
bool g_manifestScrollbarVisible = false;
bool g_manifestScrollbarDragging = false;
float g_manifestThumbHeight = 0.0f;
float g_manifestTrackHeight = 0.0f;
int g_manifestDragStartY = 0;
float g_manifestScrollStart = 0.0f;
float g_manifestScroll = 0.0f;
float g_manifestMaxScroll = 0.0f;
SDL_Rect g_sliderPanelRect = {0};
float g_sliderScroll = 0.0f;
float g_sliderMaxScroll = 0.0f;

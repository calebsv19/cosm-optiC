...
Status: bounded M0–M6 implemented in the isolated surface-material lane. See the
...
[M5 sampling/response contract](surface_material_m5_contract.md) and
[M6 graph/producer/tool contract](surface_material_m6_contract.md).

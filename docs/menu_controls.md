...
thumb capture, outside release, focus loss, and content-size clamping use one
...
reserves room for the root, mesh, and volume controls. Menu buttons use the shared
...
nudges, decimal conversion, double-click entry, shortcut capture, scroll drag and

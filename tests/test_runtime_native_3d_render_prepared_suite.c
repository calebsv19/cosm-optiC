...
static bool prepared_suite_make_temp_dir(char* out_dir, size_t out_dir_size) {
...
static bool prepared_suite_write_text_file(const char* path, const char* text) {
    FILE* file = NULL;
    size_t text_len = 0u;
...
static bool prepared_suite_write_sample_vf3d(const char* path) {
...
static bool prepared_suite_attach_dense_volume(RuntimeVolumeAttachment3D* volume,
                                               Vec3 origin,
                                               uint32_t grid_w,
                                               uint32_t grid_h,
                                               uint32_t grid_d,

...
REQUEST="$ROOT_DIR/tests/fixtures/agent_render_mesh_asset_sphere_pressure_mrt8_request.json"
OUT_ROOT="$ROOT_DIR/build/agent_runs/ray_tracing/mesh_asset_sphere_pressure_mrt8"
...
assert bvh["triangle_count"] == 16134, bvh["triangle_count"]
...
entry = audit["obj_sphere_pressure_mrt8"]

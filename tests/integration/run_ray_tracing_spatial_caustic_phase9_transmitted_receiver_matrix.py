#!/usr/bin/env python3
"""Run the Phase 9 transmitted-receiver surface-caustic matrix."""
...
def default_review_root() -> Path:
    return workspace_root() / "_private_workspace_artifacts" / "agent_runs" / "ray_tracing" / "caustic_phase9_transmitted_receiver_matrix"
...
def matrix_requests(review_root: Path) -> list[dict]:
    ...
    specs = [
        {
            "cell_id": "off_transmitted_receiver",
            "run_id": "caustic_phase9_off_transmitted_receiver",
        ...
        {
            "cell_id": "surface_cache_transmitted_receiver",
            "run_id": "caustic_phase9_surface_cache_transmitted_receiver",
            "scene_path": scene_path,
            "inspection": {
                ...
                "caustic_surface_receiver_fallback_enabled": True,
            },
        },
    ]
    requests = []
...
def baseline_for_cell(cell_id: str) -> str:
    _ = cell_id
    return "off_transmitted_receiver"
...
def write_index(path: Path, report: dict) -> None:
    ...
    lines = [
        "# Phase 9 Transmitted Receiver Matrix",
        "",
...
def main() -> int:
    ...
    for cell_id in ("surface_cache_transmitted_receiver",):
    ...
    report = {
        "schema_version": "ray_tracing_spatial_caustic_phase9_transmitted_receiver_matrix_v1",
    ...
    write_json(review_root / "phase9_transmitted_receiver_matrix_report.json", report)
    write_index(review_root / "phase9_transmitted_receiver_matrix_index.md", report)
    print(review_root / "phase9_transmitted_receiver_matrix_report.json")

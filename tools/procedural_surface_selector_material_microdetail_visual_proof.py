...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stl-tool", type=Path, default=ROOT.parent / "tools" / "procedural_object_authoring" / "procedural_stl_tool.py")
    parser.add_argument("--import-harness", type=Path, default=ROOT.parent / "line_drawing" / "build" / "toolchains" / "clang" / "bin" / "imported_mesh_harness")

...
- `scene_config.json` – Window size, ray count, object definitions (circles/polygons with transforms, colours, opacity), and Bézier path control points/handles. Parsed and written by `src/config/config_manager.c`.
